...
const createLocation = async (req, res) => {
    try {
        const { name, description, pictures, location, openingHours, ticketPrices, tags } = req.body; // Destructure the required fields from request body
...
const getLocations = async (req, res) => {
    try {
        const locations = await locationModel.find(); // Retrieve all locations from the database
...
const updateLocation = async (req, res) => {
    try {
        ...
        const { description, pictures, location, openingHours, ticketPrices, tags } = req.body; // Destructure updated data from request body
