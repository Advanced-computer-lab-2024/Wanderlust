      ...
      {loading ? (
        ...
        <>
          {cart.map((item) => (
            <div
              key={item._id}
              className="border border-gray-300 p-4 my-2 rounded-md flex justify-between items-center"
            >
              <div>
              ...
              <div className="flex flex-col items-end">
                ...
                <input
                  ...
                  value={item.quantity}
                  onChange={(e) =>
                    changeCartItemQuantity(item.product._id, e.target.value)
                  }
